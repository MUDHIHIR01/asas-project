...
const demoNews: NewsData[] = [
  { id: 1, title: "Community Giving Milestone", summary: "Celebrating our efforts in community support.", image_url: null, created_at: "2025-06-01T10:00:00Z" },
  { id: 2, title: "New Charity Initiative", summary: "Launching a new program to support local charities.", image_url: null, created_at: "2025-05-28T12:00:00Z" },
  { id: 3, title: "Volunteer Program Success", summary: "Our volunteer program makes a big impact.", image_url: null, created_at: "2025-05-20T09:00:00Z" },
];
...
const GivingBackHomeSlideshow: React.FC = () => {
  ...
  const fetchGivingBackHomes = useCallback(async () => {
    ...
    try {
      ...
      const response = await axiosInstance.get("/api/giving-back/slider", { headers });
      ...
      const message =
        "Failed to fetch giving back homes: " +
        (err.response?.data?.message || err.message || "Unknown error");
      setError(message);
      toast.error("Error fetching giving back homes.");
    } finally {
      setLoading(false);
    }
  }, []);
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-[80vh] bg-gradient-to-br from-blue-600 to-indigo-700">
  ...
  if (error && data.length === 0) {
    return (
      <div className="flex flex-col justify-center items-center min-h-[80vh] bg-gradient-to-br from-blue-600 to-indigo-700 p-6">
    ...
    return (
      <div className="flex justify-center items-center min-h-[80vh] bg-gradient-to-br from-blue-600 to-indigo-700">
        <div className="text-white text-2xl font-semibold flex items-center space-x-3">
          <InformationCircleIcon className="w-8 h-8" />
          <span>No giving back home entries found.</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <section className="relative min-h-[80vh] w-full overflow-hidden bg-gradient-to-br from-blue-600 to-indigo-700">
  ...
  return (
    <div>
      <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-6 flex items-center">
        <BuildingOffice2Icon className="w-8 h-8 mr-3 text-blue-600" />
        Featured Group
      </h2>
      {loading ? (
        ...
        >
          <img
            ...
            loading="lazy"
          />
          <h3 className="text-xl font-bold text-blue-600 dark:text-blue-400 mb-2">{ftGroup.ft_category}</h3>
          ...
          <div className="mt-auto pt-4 border-t border-gray-200 dark:border-gray-700">
            <Link
              to="/company/ft-group"
              className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-all duration-300 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
              Learn More
...
export default GivingBackHomePage;